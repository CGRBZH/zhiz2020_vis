...
const DATA_URL = "https://raw.githubusercontent.com/CGRBZH/zhiz2020_vis/master/zhiz_data_wider.csv";
      ...
      tooltip
        ...
        .call(
          ...
          [
            ...
            `Motorisierungsgrad: ${d3.format(".2f")(s.values[i])}%`,
          ],
          color(s.name)
        );
    }
